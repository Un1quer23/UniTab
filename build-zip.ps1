...
Compress-Archive -Path "$tmp\*" -DestinationPath WillowTab-v1.2.0.zip -CompressionLevel Optimal -Force

Remove-Item $tmp -Recurse -Force

Add-Type -AssemblyName System.IO.Compression.FileSystem
[System.IO.Compression.ZipFile]::OpenRead('WillowTab-v1.2.0.zip').Entries | Select-Object FullName
Write-Host "Done: WillowTab-v1.2.0.zip"
